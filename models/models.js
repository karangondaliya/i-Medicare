...
const organDonationSchema = new Schema({
  ...
  organ_type: { type: String, required: true },
  date_of_donation: { type: Date, required: [true, "Date of Donation Required"] },
}, { timestamps: true });
...
const medicalRecordSchema = new mongoose.Schema({
  ...
  total_bill: { type: Number, required: true } // Ensure this is a Number
},
{
  timestamps: true, 
});
